...
public abstract class BaseCommand implements CommandExecutor, TabExecutor {
    ...
    private final class ReflectCommand extends Command {
        private me.endergamingfilms.totemspawners.commands.BaseCommand exe = null;

        protected ReflectCommand(String command) {
            super(command);
        }

        public void setExecutor(me.endergamingfilms.totemspawners.commands.BaseCommand exe) {
            this.exe = exe;
        }
